    ...
    <div class="space-y-8">
      <div class="flex items-center space-x-4">
        <button
          ...
          onClick={() => handlePlay()}
          disabled={isLoading}
          class="px-4 py-2 bg-blue-500 text-white rounded flex items-center justify-center min-w-[80px]"
        >
          {isLoading ? (
            <>
        ...
        <div class="flex items-center space-x-2">
          ...
          <input 
            ...
            class="w-24"
          />
          <span class="text-sm text-gray-700 min-w-[40px]">{Math.round(volume * 100)}%</span>
        </div>
      </div>
